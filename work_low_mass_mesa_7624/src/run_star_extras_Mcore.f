...
!     include 'standard_run_star_extras.inc'
      ...
      subroutine extras_controls(id, ierr)
         ...
         s % other_D_mix => pavel_mixing_Mcore       
      ...
      subroutine pavel_mixing_Mcore(id, ierr)
      ...
      ! prescribed diffusion coefficient in the radiative envelope
         ...
         !  grada = s% grada_at_face(k)
            ...
            if (s% D_mix(k).lt.D_rad_env) then
               s% D_mix(k) = D_rad_env
      ...
      end subroutine pavel_mixing_Mcore
